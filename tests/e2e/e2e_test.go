...
func TestCtr(t *testing.T) {
	tests := []containerTestArgs{
		...
		{
			Image:          "harbor.nbfc.io/nubificus/urunc/hello-env-qemu-linux-initrd:latest",
			Name:           "Qemu-linux-environment-variables",
			Devmapper:      false,
			Seccomp:        true,
			UID:            0,
			GID:            0,
		...
		{
			Image:          "harbor.nbfc.io/nubificus/urunc/hello-env-firecracker-linux-initrd:latest",
			Name:           "Firecracker-linux-environment-variables",
			Devmapper:      false,
			Seccomp:        true,
			UID:            0,
			GID:            0,
